...
SOURCES = \
	__init__.py \
	geom_calc.py geom_calc_dockwidget.py

PLUGINNAME = geom_calc

PY_FILES = \
	__init__.py \
	geom_calc.py geom_calc_dockwidget.py

UI_FILES = geom_calc_dockwidget_base.ui
...
QGISDIR=C:\Users\philw\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
